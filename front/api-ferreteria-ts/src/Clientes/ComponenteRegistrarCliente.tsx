...
export default function ComponenteRegistrarCliente() {
  ...
  async function RegistrarCliente(clientes:ClienteRegistrarDTO){
    try{
    ...
    <div id="content" className="w-50"  style={{overflow:"hidden",marginTop:"20px",height:"100vh"}}>
      ...
      >
        <Form className="form-control text-white" style={{paddingBottom:"30px",paddingTop:"30px",background:"#242526", border:"3px solid #695CFE", paddingLeft:"40px"}}>
          ...
          <CompononenteCajaTexto pattern="[0-9]{1,254}" type="number" campo="numdocumento" label="DNI / CE:"/>

          <div className="row">
            <div className="col-6" style={{marginTop:"10px"}}>
              <label className="form-label" style={{fontWeight:500 , fontSize:"18px"}}>Estado:</label>
          ...
          <div className="row">
            <div className="col-6 mt-4"style={{marginTop:"10px"}}>
              ...
              <a href="/clientes" className="btn btn-danger" style={{marginLeft:"15px"}}>Cancelar</a>
            </div>
          </div>
        </Form>
      </Formik>
